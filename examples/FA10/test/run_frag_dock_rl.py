...
# config.txt
#    protein_pdb_file = protein_dir + '/2VWMA_receptor.pdb'
#    protein_pdbqt_file = protein_dir + '/2VWMA_receptor.pdbqt'
    ligand_pdb_file = protein_dir + '/2VWMA_LZI.pdb'
