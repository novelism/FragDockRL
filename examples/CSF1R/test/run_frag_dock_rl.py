...
# config.txt
#    protein_pdb_file = protein_dir + '/3KRJA_receptor.pdb'
#    protein_pdbqt_file = protein_dir + '/3KRJA_receptor.pdbqt'
    ligand_pdb_file = protein_dir + '/3KRJA_KRJ.pdb'
    ...
    params_dict = {
        'start_smi': 'N#CC1N=C(NC=1)C(=O)O',
        'smi_ref_com': 'N#CC1N=C(NC=1)C',
        'ref_atom_idx_ref': 1,
        'num_sub_proc': 16,
        'ep_dir': 'ep',
        'save_dir': 'save',
